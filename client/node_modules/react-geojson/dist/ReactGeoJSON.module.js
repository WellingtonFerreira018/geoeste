...
function ReactGeoJSON(_ref) {
  ...
  var polygons = useRef([]);
  var zoomLevel = useRef(zoom);
  var centerPoint = useRef(center);
  var activePolygon = useRef(null);
  var listenersEnabled = useRef(false);
  var selectedPolygon = useRef(null);
  var polygonBeingAdded = useRef(null);
  var selectedInfoWindow = useRef(null);

  var _useState2 = useState(false),
      polygonSelected = _useState2[0],
      setPolygonSelected = _useState2[1];

  var activeDrawingSet = useRef([]);

  var _useState3 = useState([]),
      activeDrawing = _useState3[0],
      setActiveDrawing = _useState3[1];

  var identifier = useRef(Math.random().toString(36).substring(4));
  ...
  var drawPolygon = useCallback(function (coords, name) {
    if (name === void 0) {
      name = null;
    }
  ...
  }, activeDrawing && activeDrawing.length > 0 && /*#__PURE__*/React.createElement(Action, {
    onClick: removeLastPoint
  }, "undo"), polygonSelected && /*#__PURE__*/React.createElement(Action, {
    onClick: removeSelectedPolygon
  }, "remove"), /*#__PURE__*/React.createElement(Action, {
