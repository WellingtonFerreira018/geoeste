...
function ReactGeoJSON({
  ...
  const drawPolygon = useCallback((coords, name = null) => {
    if (map === false) return;
    ...
    if (editable) {
      polygon.addListener('click', () => onPolygonClick(polygon, {
        infoWindow,
        center
      }));
    }
  ...
  function startEditing() {
    ...
    activePolygon.current.addListener('click', () => onPolygonClick(activePolygon.current));
